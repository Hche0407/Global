        ...
        <div className="container-main grid gap-16 md:grid-cols-2 md:items-center">
          ...
          <div className="max-w-xl">
            ...
            <p className="mt-6 text-base leading-7 text-slate-600 sm:text-lg">
              MigraFlow nace como una iniciativa para brindar asesoría migratoria
              personalizada, con una experiencia moderna, organizada y profesional.
            </p>

            <p className="mt-4 text-base leading-7 text-slate-600 sm:text-lg">
              Acompañamos cada caso de forma clara y transparente, facilitando la
              revisión y el seguimiento de cada trámite con dedicación y rigor legal.
            </p>
          </div>
        </div>
      </section>
